...
def data_operate(get): 
    with open('D:\OneDrive\COMPYear3Sem1\COMP3122\project\lipstick.json', 'r', encoding='utf-8') as f: 
      ret_dic = json.load(f) 
    ...
    #the third loop covert value_array to RGB_array# 
      ...
      for i in range(3): 
          idex=result[i]
          result_return.append(str(sum_list[idex]))
          print(sum_list[idex]) 
...
def lip_handle(realname):
    
    list=[] 
    color_dir='D:\OneDrive\COMPYear3Sem1\COMP3122\project'+str(realname)
